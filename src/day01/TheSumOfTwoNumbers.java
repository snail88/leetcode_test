...
public class TheSumOfTwoNumbers {
    public static void main (String[] args){
        ...
        theSumOfTwoNumbers.twoSum1(arr,100);
//        System.out.println(theSumOfTwoNumbers.twoSum(arr,53));
    }

    /**
     * 暴力法 :暴力法很简单。遍历每个元素 xx，并查找是否存在一个值与 target - x相等的目标元素。
     * @param nums
     * @param target
     * @return
     */
